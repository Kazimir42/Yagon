        ...
        <main className="flex min-h-screen flex-col items-center">
            ...
            <div className={'flex flex-col max-w-xl w-full items-center gap-6'}>
                <div className={'flex flex-row gap-2 w-full items-center'}>
                    ...
                    <button className={'text-2xl font-light rounded-full bg-primary text-white shadow-lg px-3 py-3 text-center hover:bg-primary hover:bg-opacity-90 transition duration-200'}>
                        <Search />
                    </button>
                    <p className={'text-3xl text-gray-300 mx-3'}>|</p>
                    <button className={'text-2xl font-light rounded-full bg-primary text-white shadow-lg px-3 py-3 text-center hover:bg-primary hover:bg-opacity-90 transition duration-200'}>
                        <QrCode />
                    </button>
                </div>
